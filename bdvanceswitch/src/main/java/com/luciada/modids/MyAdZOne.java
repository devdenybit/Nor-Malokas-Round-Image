...
public class MyAdZOne {
    ...
    private void LoadGoogleNativeSmall() {
        ...
        // RelativeLayout.LayoutParams fsf = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        //  fsf.addRule(RelativeLayout.CENTER_IN_PARENT);
        //  admobNativeBanerLayout.setLayoutParams(fsf);
    ...
    private void LoadGoogleNativeSmall2() {
        ...
        //  RelativeLayout.LayoutParams fsf = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        //  fsf.addRule(RelativeLayout.CENTER_IN_PARENT);
        //  admobNativeBanerLayout2.setLayoutParams(fsf);
    ...
    private void LoadGoogleNativeSmall3() {
        ...
        // RelativeLayout.LayoutParams fsf = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        // fsf.addRule(RelativeLayout.CENTER_IN_PARENT);
        // admobNativeBanerLayout3.setLayoutParams(fsf);
    ...
    public void populateUnifiedNativeAdView(NativeAd nativeAd, ViewGroup nativeAdContainer) {
        ...
        if (Native_Ad_Shape_Round_Corner.equals("true")) {
            view = inflater.inflate(R.layout.native_admob_round, null);
    ...
    public void onlyCustInterstitialCallAD(Activity activity) {
        ...
        if (app_OnlyInterstitalADShow.equalsIgnoreCase("true")) {
            ...
            if (app_CustomeADText.equalsIgnoreCase("Qureka")) {
                ...
                View dialogView = LayoutInflater.from(activity).inflate(R.layout.cust_ad_interstitial, viewGroup, false);
